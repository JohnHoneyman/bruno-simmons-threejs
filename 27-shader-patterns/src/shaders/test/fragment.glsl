...
void main()
{
    ...
    // strength = step(0.5, strength); (another way)
    ...
    // float strength = distance(vUv, vec2(0.5)); // Other way

    // // Pattern 28
    // float strength = 1.0 - distance(vUv, vec2(0.5));

    // // Pattern 29
    // float strength = 0.015 / distance(vUv, vec2(0.5)) + 0.05; // 0.05 to add intensity
    ...
    // gl_FragColor = vec4(vUv, 1, 1.0); // Pattern 1
    // gl_FragColor = vec4(vUv, 0, 1.0); // Pattern 2
    // gl_FragColor = vec4(vUv, 0.5, 1.0); // Pattern 2.1
